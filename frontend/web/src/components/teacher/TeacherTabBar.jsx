// Mobile-only bottom tab bar for the teacher portal. The teacher nav has 7 items
// — too many for a bottom bar — so we show 5 primary tabs (Dashboard, My Classes,
// Homework, Marks, Notices) and tuck the rest (Library, Profile) behind a "More"
// tab that opens a small sheet above the bar.
//
// Same scroll model as the student tab bar: position:fixed, page scrolls behind
// it, safe-area inset for the iOS home indicator. Standalone file so the mobile
// nav (and its overflow menu) can be tweaked/debugged apart from the desktop
// sidebar.
...
export function TeacherTabBar({ primary, more, active }) {
